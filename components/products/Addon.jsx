...
export default function Addon({ id, name, price, image, tooltip, selected, clickHandler }) {
    ...
    return (
        <div className='flex flex-col items-center group shadow' onClick={() => clickHandler({ id, name, price })}>
            <div className="rounded-full mb-2">
                <i
                    className={
                        `block w-16 h-16 rounded-full bg-emerald-500 transition-all group-hover:bg-emerald-400 
